...
export default function Hero() {
  return (
    <section className="relative overflow-hidden bg-gradient-to-br from-[#0A1628] via-[#0d1f35] to-[#1a365d] pt-20 pb-14">
      ...
      <div className="absolute inset-0 pointer-events-none">
        {[...Array(20)].map((_, i) => (
          <motion.div
            ...
            transition={{ duration: 4 + Math.random() * 2, repeat: Infinity, delay: Math.random() * 1.5 }}
          />
        ))}
      </div>
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="max-w-3xl mx-auto text-center lg:text-left">
          ...
          <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-white leading-tight mb-6">
            灵活用工
            <br />
            <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-400 to-cyan-400">智领未来</span>
          </h1>
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center lg:justify-start gap-4 mb-10">
            ...
            <Button asChild size="lg" variant="outline" className="bg-white border-transparent text-black hover:bg-white/90 rounded-full px-8">
        ...
        {/* 视频紧跟文本区 */}
        <div className="relative w-full h-72 md:h-80 lg:h-96 overflow-hidden rounded-3xl border border-white/10 shadow-2xl mb-10">
          <video
